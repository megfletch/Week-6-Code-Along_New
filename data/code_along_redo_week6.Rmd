...
Additional assumptions to consider about linearregression and resiudals:
...
Pearson's *r* ranges in value from -1 to 1:
-1 = perfectly negatively correlated - as one variable increases the other decreases 
1 = perfectly positively correlated - as one variable increases the other increases 
0 = means that there is no degree of relationship between the two variables
